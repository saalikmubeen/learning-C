...
// Another way to pass a reference to a function is to pass a pointer to the
// function, in this case we pass a pointer to an int, and we can use the pointer
// to modify the value of the variable in the calling environment that was passed
// as an argument
