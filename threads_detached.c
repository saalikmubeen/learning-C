...
void* routine(void* args) {
    while (1) {
        ...
        // pthread_barrier_wait() is a blocking call that waits for all the threads
        // to reach the barrier (i.e. call pthread_barrier_wait()) Once all the
        // threads (in this case 10) have reached the barrier, the barrier is released
        // and all the threads are allowed to continue.
